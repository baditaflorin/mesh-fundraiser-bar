...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-fundraiser-bar-e07a5f)](https://baditaflorin.github.io/mesh-fundraiser-bar/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-fundraiser-bar/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Live fundraiser thermometer toward a goal, no payments, mesh-synced tracking

Live: **https://baditaflorin.github.io/mesh-fundraiser-bar/**

Source: **https://github.com/baditaflorin/mesh-fundraiser-bar**
...
git clone https://github.com/baditaflorin/mesh-fundraiser-bar
cd mesh-fundraiser-bar
npm install
npm run dev
```
...
- `mesh-fundraiser-bar:signalingUrl`
- `mesh-fundraiser-bar:turnTokenUrl`
- `mesh-fundraiser-bar:iceServers`
- `mesh-fundraiser-bar:room`
